...
class SettingSeeder extends Seeder
{
    ...
    {
        // General Settings
        Setting::updateOrCreate(['name' => 'site_title','value' => 'Bank']);
        Setting::updateOrCreate(['name' => 'site_description','value' => 'Bank website']);
        Setting::updateOrCreate(['name' => 'site_address','value' => 'Bangladesh']);
        // Logo Settings
        ...
        Setting::updateOrCreate(['name' => 'mail_from_name','value' => 'Bank']);
