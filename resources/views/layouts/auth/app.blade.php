...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('dashboard/css/pages/page-auth.css')}}">
...
<script src="{{asset('dashboard/vendors/js/forms/validation/jquery.validate.min.js')}}"></script>
<!-- END: Page Vendor JS-->
